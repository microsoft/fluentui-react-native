...
A callout is an anchored tip that can be used to teach people or guide them through the app without blocking them. The
component is an unstyled native primitive: it applies no theme or visible appearance defaults. Transparent and zero-valued
native style fallbacks keep the macOS layer safe when border and background props are omitted.
...
`CalloutProps extends ViewProps, CalloutTokens`
...
| componentRef                    | `React.Ref<CalloutHandle>`                     |               | A ref that exposes `focusWindow()` and `blurWindow()`.                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
These values are applied only when supplied by the caller. User `style` is applied last.
...
| backgroundColor  | ColorValue         |               | Defines the native Callout background color.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| beakWidth        | number             |               | Width of the beak on the Callout indicating its anchor.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| borderColor      | ColorValue         |               | Defines the native Callout border color.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| borderRadius     | string or number   |               | Defines the native Callout corner radius.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| borderWidth      | number             |               | Defines the native Callout border width.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| minWidth         | string or number   |               | Defines a minimum width for the Callout.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
