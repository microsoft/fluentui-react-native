...
| --------------------------------- | ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| `switch-label-association-ids`    | Deferred    | When the caller supplies no name, the component generates label ids, points the root's labelled-by props at them, _and_ copies the label text onto the root as its accessible name. The generated ids are not assigned to the rendered label elements, and the labels themselves are hidden from assistive technology, so the name in practice comes from the copied text. Flex expects the visible label element to be the named target. | Assign the generated ids to the label slots, or drop the labelled-by props and keep the copied name as the single mechanism. |
