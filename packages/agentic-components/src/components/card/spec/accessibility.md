...
| 2.4.7 — Focus Visible _(interactive)_                    | The surface shows the system dual-outline focus ring (inherits the surface radius) in all non-disabled states — see `flex-system:styling`.                                                                                                        |
