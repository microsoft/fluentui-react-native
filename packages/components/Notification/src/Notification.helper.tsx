...
export function getDismissSvgProps() {
...
/**
 * Depending on what props are passed in, either an action button or dismiss button will be rendered.
 ...
 */
export function getNotificationButtonType(userProps: NotificationProps) {
