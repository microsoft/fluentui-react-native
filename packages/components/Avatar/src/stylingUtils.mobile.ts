...
export function getFallbackIconPath(avatarColor: AvatarColor) {
  ...
  if (filledIcon) {
    return 'M10.5 2C8.29086 2 6.5 3.79086 6.5 6C6.5 8.20914 8.29086 10 10.5 10C12.7091 10 14.5 8.20914 14.5 6C14.5 3.79086 12.7091 2 10.5 2ZM5.50873 11C4.40315 11 3.5 11.8869 3.5 13C3.5 14.6912 4.33281 15.9663 5.63499 16.7966C6.91697 17.614 8.64526 18 10.5 18C12.3547 18 14.083 17.614 15.365 16.7966C16.6672 15.9663 17.5 14.6912 17.5 13C17.5 11.8956 16.6045 11 15.5 11L5.50873 11Z';
  } else {
