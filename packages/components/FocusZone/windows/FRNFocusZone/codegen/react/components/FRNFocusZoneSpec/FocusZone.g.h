...
struct FocusZoneProps : winrt::implements<FocusZoneProps, winrt::Microsoft::ReactNative::IComponentProps> {
    ...
    : ViewProps(props)
  {
     if (cloneFrom) {
       ...
       use2DNavigation = cloneFromProps->use2DNavigation;
       tabKeyNavigation = cloneFromProps->tabKeyNavigation;
  ...
  REACT_FIELD(defaultTabbableElement)
  winrt::Microsoft::ReactNative::JSValue defaultTabbableElement{nullptr};

  REACT_FIELD(focusZoneDirection)
  std::optional<std::string> focusZoneDirection;

  REACT_FIELD(use2DNavigation)
  std::optional<bool> use2DNavigation{};

  REACT_FIELD(tabKeyNavigation)
  std::optional<std::string> tabKeyNavigation;

  REACT_FIELD(disabled)
  std::optional<bool> disabled{};

  REACT_FIELD(isTabNavigation)
  std::optional<bool> isTabNavigation{};
