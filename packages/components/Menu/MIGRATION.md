...
`ContextMenu` is now named `Menu`:

| v0 `ContextMenu`                           | v1 `Menu`                                            |
| ------------------------------------------ | ---------------------------------------------------- |
...
### Migrating customized ContextMenus
...
### Migrating composed ContextMenus
...
Our version of the `Menu` currently does not support:
