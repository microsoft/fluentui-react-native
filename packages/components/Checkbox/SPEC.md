...
More examples on the [Test pages for the Checkbox](../../../apps/fluent-tester/src/TestComponents/Checkbox). Instructions on running the tester app can be found [here](../../../apps/fluent-tester/README.md).
