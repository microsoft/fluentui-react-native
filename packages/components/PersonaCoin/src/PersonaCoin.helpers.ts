...
const colorTable: { [P in PersonaCoinColor]: string } = {
  lightBlue: colorCornflowerPrimary,
  blue: colorBluePrimary,
  darkBlue: colorRoyalBluePrimary,
  teal: colorTealPrimary,
  green: colorForestPrimary,
  darkGreen: colorDarkGreenPrimary,
  lightPink: colorBerryPrimary,
  pink: colorHotPinkPrimary,
  magenta: colorGrapePrimary,
  purple: colorPurplePrimary,
  orange: colorPumpkinPrimary,
  lightRed: colorRedPrimary,
  darkRed: colorBurgundyPrimary,
  violet: colorOrchidPrimary,
  gold: colorBrassPrimary,
  burgundy: colorDarkRedPrimary,
  warmGray: colorBeigePrimary,
  cyan: colorSteelPrimary,
  rust: colorBrownPrimary,
  coolGray: colorPlatinumPrimary,
};
...
const colorTableFluent: { [P in PersonaCoinFluentColor]: string } = {
  cornflower: colorCornflowerPrimary,
  blue: colorBluePrimary,
  royalBlue: colorRoyalBluePrimary,
  teal: colorTealPrimary,
  forest: colorForestPrimary,
  darkGreen: colorDarkGreenPrimary,
  berry: colorBerryPrimary,
  hotPink: colorHotPinkPrimary,
  grape: colorGrapePrimary,
  purple: colorPurplePrimary,
  pumpkin: colorPumpkinPrimary,
  red: colorRedPrimary,
  burgundy: colorBurgundyPrimary,
  orchid: colorOrchidPrimary,
  brass: colorBrassPrimary,
  darkRed: colorDarkRedPrimary,
  beige: colorBeigePrimary,
  platinum: colorPlatinumPrimary,
  steel: colorSteelPrimary,
  brown: colorBrownPrimary,
};
