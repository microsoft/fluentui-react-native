...
Pod::Spec.new do |s|
  s.name             = 'FluentUI-React-Native-ActivityIndicator'
  s.version          = "#{version}"
  s.summary          = 'Fluent UI React Native ActivityIndicator Control'
  ...
  s.swift_version    = "5"
  s.module_name      = 'FluentUIReactNativeActivityIndicator'
