export type { GetMemoValue } from '@fluentui-react-native/framework-base/memo-cache';
export { getMemoCache, memoize } from '@fluentui-react-native/framework-base/memo-cache';

export type { StyleProp } from '@fluentui-react-native/framework-base/merge-props';
export { mergeProps, mergeStyles } from '@fluentui-react-native/framework-base/merge-props';
...
export { immutableMerge, immutableMergeCore, processImmutable } from '@fluentui-react-native/framework-base/immutable-merge';
export type {
  ...
  RecursionHandler,
  RecursionOption,
} from '@fluentui-react-native/framework-base/immutable-merge';
