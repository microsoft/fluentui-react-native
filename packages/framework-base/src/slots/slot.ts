import type { AsIntrinsicElement, SlotComponentType, SlotShorthandValue, UnknownSlotProps } from '../types/slotType';
import * as React from 'react';
import { SLOT_ELEMENT_TYPE_SYMBOL } from '../types/constants';
import type { JSXIntrinsicElementKeys } from '../types/components';
...
export function always<Props extends UnknownSlotProps>(
  _value: Props | SlotShorthandValue | undefined,
  _options: SlotOptions<Props>,
  ...
  */
  ...
  return {} as SlotComponentType<Props>;
}
 ...
 */
export function resolveShorthand<Props extends UnknownSlotProps | null | undefined>(value: Props | SlotShorthandValue): Props {
  if (
    typeof value === 'string' ||
    typeof value === 'number' ||
    isIterable(value) ||
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const isIterable = (value: unknown): value is Iterable<any> => typeof value === 'object' && value !== null && Symbol.iterator in value;
