...
<!-- This log was last generated on Tue, 15 Jul 2025 23:27:13 GMT and should not be manually modified. -->

<!-- Start content -->

## 0.13.9

Tue, 15 Jul 2025 23:27:13 GMT
...
Wed, 10 Jul 2024 16:16:42 GMT

### Patches

- Export shimmer consts (ruaraki@microsoft.com)
...
- Make Shimmer respect backgroundColor and containerBorderRadius (adgleitm@microsoft.com)
...
- Add RTL support to win32 Shimmer (saadnajmi2@gmail.com)
...
- Add viewBox information to the Shimmer SVGs for high DPI support and rework the clipping mask workaround to be the same size as the viewBox (patboyd@microsoft.com)
...
- Import assert-never (email not defined)
