...
export const renderContextualMenu = (contextualMenu: ContextualMenuProps, menuItems: MenuButtonItemProps[]) => {
  return (
    <ContextualMenu {...contextualMenu}>
      {menuItems?.map((menuItem) => {
        return menuItem.hasSubmenu ? (
          <SubMenuItem key={menuItem.itemKey} {...menuItem} />
        ) : (
...
const SubMenuItem: React.FunctionComponent<MenuButtonItemProps> = (props: MenuButtonItemProps) => {
