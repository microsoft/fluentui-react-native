/**
 * Lifted from the priority-overflow package within the microsoft/fluentui github repo:
 * https://github.com/microsoft/fluentui/blob/master/packages/react-components/priority-overflow/src/priorityQueue.ts
 */
