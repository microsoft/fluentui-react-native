import { toggleButtonName, ToggleButtonTokens, ToggleButtonSlotProps, ToggleButtonComposedProps } from './ToggleButton.types';
...
export const stylingSettings: UseStylingOptions<ToggleButtonComposedProps, ToggleButtonSlotProps, ToggleButtonTokens> = {
