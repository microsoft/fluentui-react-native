import { buttonName, ButtonCoreTokens, ButtonTokens, ButtonSlotProps, ButtonComposedProps, ButtonSize } from './Button.types';
...
export const stylingSettings: UseStylingOptions<ButtonComposedProps, ButtonSlotProps, ButtonTokens> = {
