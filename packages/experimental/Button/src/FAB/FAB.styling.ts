import { ButtonCoreTokens, ButtonSlotProps, ButtonComposeCoreProps } from '../Button.types';
...
export const stylingSettings: UseStylingOptions<ButtonComposeCoreProps, ButtonSlotProps, ButtonCoreTokens> = {
