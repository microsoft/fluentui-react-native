...
function overrideBrandAliasTokensWithOffice(theme: Theme): Partial<AliasColorTokens> {
  return {
    ...
    brandBackground1: theme.host.colors.AppPrimary,
    brandBackground1Hover: theme.host.colors.AppShade10,
    brandBackground1Pressed: theme.host.colors.AppShade30,
    brandBackground1Selected: theme.host.colors.AppShade20,
