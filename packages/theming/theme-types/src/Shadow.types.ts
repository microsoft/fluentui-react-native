...
/**
 * Base structure of a shadow, which has x and y offset, blur amount, and color specified
 */
 ...
 */
export type PartialShadowToken = { [P in keyof ShadowToken]?: Partial<Shadow> };
