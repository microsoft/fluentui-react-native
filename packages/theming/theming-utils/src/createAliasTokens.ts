...
function createAliasTokensWorker(mode: AppearanceOptions): AliasColorTokens {
  ...
  return {
    ...
    brandBackground1: aliasTokens.brandBackground.fillColorRest,
    brandBackground1Hover: aliasTokens.brandBackground.fillColorHover,
    brandBackground1Pressed: aliasTokens.brandBackground.fillColorPressed,
    brandBackground1Selected: aliasTokens.brandBackgroundSelected.fillColorRest,
