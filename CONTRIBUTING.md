...
1. Follow [these instructions](https://microsoft.github.io/react-native-windows/docs/init-windows-cli#templates) to use init-windows to create a modules using the lib-cpp template. Complete all steps in [Native Platform: Native Modules](https://microsoft.github.io/react-native-windows/docs/native-platform-modules).
...
4. Testing the component locally
   1. Add your native module references within the `App.js` file.
      - `Import { NewComponent } from @fluentui-react-native/experimental-<new-component>;`
   2. Start metro via command line
