...
- Make sure you have setup an [Android Virtual Device](https://developer.android.com/studio/run/managing-avds)
  - M1 Macs: Current best emulator is to still download from Github, [version 3](https://github.com/google/android-emulator-m1-preview)
