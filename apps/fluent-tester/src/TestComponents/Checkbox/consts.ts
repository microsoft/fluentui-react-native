...
/* Test Legacy Checkbox 1 */
export const CHECKBOX_TEST_COMPONENT_LEGACY = 'Checkbox_Test_Component_Legacy'; // A component on each specific test page
export const CHECKBOX_ACCESSIBILITY_LABEL_LEGACY = 'E2E testing Checkbox accessibility label';

/* Test Checkbox 2 */
export const CHECKBOX_NO_A11Y_LABEL_COMPONENT_LEGACY = 'Checkbox_No_A11y_label_Component_Legacy';
export const CHECKBOX_TEST_COMPONENT_LABEL_LEGACY = 'Test Checkbox2 - No Accessibility Label'; // A component on each specific test page
