...
describe('Click on each test page and check if it renders', function () {
  ...
  it('Is Theme Page Displayed', () => {
    expect(ThemeTestPage.isButtonInView()).toBeFalsy();
  });

  it('Try Scrolling to ThemePage', () => {
    browser.saveScreenshot('./errorShots/beforeScroll.png');
    ThemeTestPage.scrollToButton();
    browser.saveScreenshot('./errorShots/afterScroll.png');
