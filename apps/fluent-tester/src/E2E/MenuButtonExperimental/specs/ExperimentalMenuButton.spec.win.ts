...
import { EXPERIMENTAL_MENU_BUTTON_ACCESSIBILITY_LABEL, EXPERIMENTAL_MENU_BUTTON_TEST_COMPONENT_LABEL } from '../../../FluentTester/TestComponents/MenuButtonExperimental/consts';
...
describe('Experimental MenuButton Accessibility Testing', () => {
  ...
  it('Experimental MenuButton - Set accessibilityLabel', () => {
    ExperimentalMenuButtonPageObject.scrollToTestElement();
    ExperimentalMenuButtonPageObject.waitForPrimaryElementDisplayed(PAGE_TIMEOUT);
    expect(ExperimentalMenuButtonPageObject.getAccessibilityLabel(ComponentSelector.Primary)).toEqual(EXPERIMENTAL_MENU_BUTTON_ACCESSIBILITY_LABEL);
  });

  it('Do not set accessibilityLabel -> Default to Experimental MenuButton label', () => {
    ExperimentalMenuButtonPageObject.scrollToTestElement();
    ExperimentalMenuButtonPageObject.waitForPrimaryElementDisplayed(PAGE_TIMEOUT);
    expect(ExperimentalMenuButtonPageObject.getAccessibilityLabel(ComponentSelector.Secondary)).toEqual(EXPERIMENTAL_MENU_BUTTON_TEST_COMPONENT_LABEL);
  });
});
