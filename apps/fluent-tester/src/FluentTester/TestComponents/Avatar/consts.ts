...
export const JSAVATAR_ACCESSIBILITY_LABEL = 'E2E Avatar Accessibility label';
export const JSAVATAR_ACCESSIBILITY_LABEL_BY_NAME = 'Richard, available';
export const JSAVATAR_ACCESSIBILITY_HINT = 'E2E Avatar Accessibility hint';
export const JSAVATAR_ACCESSIBILITY_ROLE = 'none';
