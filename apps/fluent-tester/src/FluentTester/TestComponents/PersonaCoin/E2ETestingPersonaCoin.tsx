...
export const E2ETestingPersonaCoin: React.FunctionComponent = () => {
  ...
  return (
    <View style={commonStyles.root}>
      ...
      <PersonaCoin
        ...
        testID={PERSONACOIN_TEST_COMPONENT}
        accessibilityLabel={PERSONACOIN_ACCESSIBILITY_LABEL}
      />
      <PersonaCoin
        size={imageSize === undefinedText ? undefined : imageSize}
        initials="SN"
        imageDescription={PERSONACOIN_TEST_COMPONENT_LABEL}
        presence={presence === undefinedText ? undefined : presence}
        imageUrl={showImage ? satyaPhotoUrl : undefined}
        coinColorFluent={coinColor === undefinedText ? undefined : coinColor}
        testID={PERSONACOIN_NO_A11Y_LABEL_COMPONENT}
      />
    </View>
  );
};
