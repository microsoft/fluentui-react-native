...
import { PERSONA_TEST_COMPONENT, PERSONA_ACCESSIBILITY_LABEL, PERSONA_NO_A11Y_LABEL_COMPONENT } from './consts';
...
export const E2ETestingPersona: React.FunctionComponent = () => {
  ...
  return (
    <View style={commonStyles.root}>
      ...
      <Persona
        ...
        accessibilityLabel={PERSONA_ACCESSIBILITY_LABEL}
      />
      <Persona
        text={showPrimary ? PERSONA_NO_A11Y_LABEL_COMPONENT : undefined}
        secondaryText={showSecondary ? 'Executive Vice President' : undefined}
        tertiaryText={showTertiary ? 'E & D' : undefined}
        optionalText={showOptional ? 'Building 36/5600' : undefined}
        size={imageSize}
