...
import { MENUITEM_ACCESSIBILITY_LABEL, MENUITEM_TEST_LABEL } from '../../../../fluent-tester/src/TestComponents/Menu/consts';
...
describe('Menu Accessibility Testing', () => {
  ...
  it('Validate accessibilityRole of menu item is correct', async () => {
  ...
  it('Do not set accessibilityLabel -> Default to MenuItem label', async () => {
    await expect(
  ...
  it('Click menu -> ExpandCollapseState correctly changes', async () => {
    await expect(
