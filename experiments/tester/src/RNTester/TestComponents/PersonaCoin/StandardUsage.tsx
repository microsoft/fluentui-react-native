  ...
  return (
    <View style={styles.root}>
      ...
      <View style={styles.settings}>
        ...
        <Picker prompt="Size" style={styles.header} selectedValue={imageSize} onValueChange={setImageSize}>
          {allSizes.map((size, index) => (
            <Picker.Item label={size} key={index} value={size} />
          ))}
        </Picker>

        <Picker prompt="Coin color" style={styles.header} selectedValue={coinColor} onValueChange={setCoinColor}>
          {allColors.map((color, index) => (
            <Picker.Item label={color} key={index} value={color} />
          ))}
        </Picker>

        <Picker prompt="Presence status" style={styles.header} selectedValue={presence} onValueChange={setPresence}>
